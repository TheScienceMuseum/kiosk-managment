 ...
 * Generated for Laravel 5.7.15 on 2019-01-28 12:14:39.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Request {
        ...
        {
            return \Illuminate\Http\Request::Spatie\QueryBuilder\{closure}($include);
        }
        ...
        {
            return \Illuminate\Http\Request::Spatie\QueryBuilder\{closure}($append);
        }
        ...
        {
            return \Illuminate\Http\Request::Spatie\QueryBuilder\{closure}($filter);
        }
        ...
        {
            return \Illuminate\Http\Request::Spatie\QueryBuilder\{closure}();
        }
        ...
        {
            return \Illuminate\Http\Request::Spatie\QueryBuilder\{closure}($default);
        }
