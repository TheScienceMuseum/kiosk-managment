...
class CustomPagesModelSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $model = $customPage->addMedia('./database/seeds/assets/ironman.zip')->toMediaCollection('assets');
        $customPageData->asset->assetId = $model->id;

        $titleImage = $customPage->addMedia('./database/seeds/assets/iron-man.jpg')->toMediaCollection('images');
